...
- **Desktop App Fixed**: August 3, 2025 - Resolved package.json main entry point issue (was pointing to sw.js instead of electron/main.js), authentication bypass for desktop environment, and file loading method optimization
