class Auth {
    ...
    checkSession() {
        ...
        if (session) {
            ...
            // Session expires after 24 hours (or 7 days for desktop)
            const sessionDuration = (typeof window !== 'undefined' && window.electronAPI) 
        ...
        return new Promise((resolve) => {
                        ...
                        <form id="loginForm" class="login-form">
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class="form-check-label" for="rememberMe">
                                    Keep me logged in (${(typeof window !== 'undefined' && window.electronAPI) ? '7 days - Desktop' : '24 hours - Web'})
                                </label>
                            </div>
            ...
            form.addEventListener('submit', (e) => {
                ...
                if (this.validatePassword(enteredPassword)) {
                    ...
                    // Clear the desktop auth attempts on successful login
                    if (window.desktopAuth) {
                        window.desktopAuth.clearAttempts();
                    }
