...
class SampleDataGenerator {
    ...
    async generateSampleData() {
        try {
            // Check if user has disabled sample data generation
            const sampleDataDisabled = localStorage.getItem('sampleDataDisabled');
            if (sampleDataDisabled === 'true') {
                console.log('Sample data generation is disabled by user');
                return;
            }
